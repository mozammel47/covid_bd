...
output: 
  flexdashboard::flex_dashboard:
    ...
    css: style.css
    social: menu
    source_code: https://github.com/mozammel47/covid_bd
runtime: shiny    
---
<style>                     
.navbar {
...
covid_data= readr::read_csv("https://covid.ourworldindata.org/data/owid-covid-data.csv")
covid_data.bd = covid_data %>% filter(location == "Bangladesh")

covid_data.bd = covid_data.bd %>% 
  mutate(seven_avg_case= rollmean(new_cases, 7, align="right", fill=0)) %>%
  mutate(seven_avg_death= rollmean(new_deaths, 7, align="right", fill=0))
...
```{r}
renderText({
print("Our World in Data (https://github.com/owid/covid-19-data). Johns Hopkins University Center for Systems Science and Engineering (JHU CCSE) Coronavirus repository (https://github.com/CSSEGISandData/COVID-19).")
})        
```
